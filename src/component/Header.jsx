  ...
  return (
    <section className="w-full flex justify-center items-center py-3 fixed navBarActive">
      <div className="container px-3 flex justify-between items-center">
        ...
        <Link to='/contact' className="hover:-translate-y-1 ease-in-out duration-700 hidden md:flex headerBtn p-2 text-center bg-primary hover:bg-opacity-80 rounded-md text-white">
          Contact Me
        </Link>
        ...
        <div className={`absolute w-[250px] h-[100vh] flex flex-col p-4 top-0 bg-white shadow-md  justify-between md:hidden ease-in-out duration-700 ${!navMenu ? '-left-full' : 'left-0'}`}>
          ...
          <Link to='/contact' className="hover:-translate-y-1 ease-in-out duration-700 flex self-center headerBtn p-2 text-center bg-primary hover:bg-opacity-80 rounded-md text-white">
            Contact Me
          </Link>
        </div>
        </div>
